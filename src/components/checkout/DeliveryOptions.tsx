...
const DeliveryOptions = ({
  ...
  useEffect(() => {
    ...
    const isPaymentValid =
      payment && deliveryOptions.some((option) => option.id === payment.id);
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      {deliveryOptionsLoading ? (
        ...
        <>
          <div className="flex flex-col gap-14 lg:gap-3">
          ...
          <div className="flex items-center gap-2 mb-10">
            ...
            <p className="max-w-[566px] text-gray-2 mt-5 lg:mt-0">
              Please note that all international shipments may be subject to
              customs duties and taxes depending on your local regulations.
              These charges are the full responsibility of the buyer and are not
      ...
      <div className="flex justify-between items-center mb-2 font-bold uppercase px-6">
        <span>Shipping</span>
        <span>
          {selectedDeliveryOption ? `$${selectedDeliveryOption.price}` : "-"}
        </span>
      </div>
