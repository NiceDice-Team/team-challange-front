...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        "flex h-10 w-fit min-w-[176px] items-center gap-2 rounded-md border px-3 py-2 text-sm whitespace-nowrap",
        className,
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="h-4 w-4  text-[var(--color-purple)] shrink-0" />
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          "relative z-50 overflow-hidden rounded-md border bg-popover shadow-lg",
          className,
        )}
        position="popper"
        side="bottom"
