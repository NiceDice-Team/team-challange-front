...
const HOME_CATALOG_LINKS = {
  newArrivals: "/catalog?categories=1",
  bestsellers: "/catalog?categories=2",
  sale: "/catalog?categories=4",
  boardGames: "/catalog",
};
    ...
    <section className="mb-12 sm:mb-16 md:mb-20 lg:mb-24 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6 max-w-[1320px] mx-auto">
        ...
        <div className="w-full">
          <Link
            href={HOME_CATALOG_LINKS.newArrivals}
            className="flex flex-col h-64 sm:h-80 md:h-[400px] lg:h-[500px] xl:h-[648px]"
          >
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-4 sm:gap-5 md:gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
            {/* BESTSELLERS Card */}
            <Link
              href={HOME_CATALOG_LINKS.bestsellers}
              className="flex flex-col h-48 sm:h-36 md:h-40 lg:h-48 xl:h-[312px]"
            >
              <div className="relative flex-grow overflow-hidden">
                <Image
                  src={NEW_GAME1_IMG}
          ...
          {/* BOARD GAMES Card */}
          <Link
            href={HOME_CATALOG_LINKS.boardGames}
            className="flex w-full flex-col h-48 sm:h-40 md:h-44 lg:h-52 xl:h-[312px]"
          >
            <div className="relative flex-grow overflow-hidden">
              <Image
                src={NEW_GAME4_IMG}
